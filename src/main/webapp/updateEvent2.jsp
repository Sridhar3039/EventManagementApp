...
<nav>
      ...
      if(detail_id!=0){
		...
		EventDetails eventDetails=ed.getEventDetails(detail_id);
		{%>
  		<form action="updateEventDetails" method="post">
   <input type="tel" name="detail_id" value="<%=eventDetails.getDetail_id()%>">
    <input type="tel" name="event_id" value="<%=eventDetails.getEvent_id()%>">
     <input type="text" name="detail_type" value="<%=eventDetails.getDetail_type() %>">
      <input type="text" name="detail_description" value="<%=eventDetails.getDetail_description()%>">
       <input type="tel" name="price" value="<%=eventDetails.getPrice() %>">
        <input type="tel" name="room_capacity" value="<%=eventDetails.getRoom_capacity() %>">
         <input type="text" name="image_url" value="<%=eventDetails.getImage_url()%>">
